...
{flag=false;if(!(blockMenuRight.hasClass("active-menu"))){blockMenuRight.addClass("active-menu");blockMenuRight.animate({width:"+=240"},function(){flag=true;});}else{blockMenuRight.animate({width:"-=240"},function(){blockMenuRight.removeClass("active-menu");flag=true;});}}
